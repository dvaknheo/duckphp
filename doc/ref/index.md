...
5. `Ext` 目录是扩展目录，按字母排序。非默认加载的扩展
   ...
   2. [FacadesAutoLoader.php](Ext-FacadesAutoLoader.md) 门面组件用于偷懒
        1. [FacadesBase.php](Ext-FacadesBase.md) 门面类的基类
   3. [JsonRpcExt.php](Ext-JsonRpcExt.md) Json 远程调用组件
        1. [JsonRpcClientBase.php](Ext-JsonRpcClientBase.md)
   4. [JsonView.php](Ext-JsonView.md) Json 视图组件
   5. [Misc.php](Ext-Misc.md) 杂项功能组件
   6. [RedisCache.php](Ext-RedisSimpleCache.md) redis 缓存组件
   7. [RedisManager.php](Ext-RedisManager.md) Redis管理器组件
   8. [RouteHookDirectoryMode.php](Ext-RouteHookDirectoryMode.md) 多个目录基准的模式组件
   9. [RouteHookManager.php](Ext-RouteHookManager.md) 路由钩子管理器
   10. [RouteHookRewrite.php](Ext-RouteHookRewrite.md) 路由重写组件
   11. [StrictCheck.php](Ext-StrictCheck.md) 严格检查模式组件
6. `Helper` 目录，各种助手类
