...
+ 'context_class' => null
    - [DuckPhp\Ext\Pager](Ext-Pager.md)
...
+ 'redis' => null
    - [DuckPhp\Ext\RedisSimpleCache](Ext-RedisSimpleCache.md)
...
+ 'swoole_ext_class' => "SwooleHttpd\\SwooleExt"
    - [DuckPhp\Ext\PluginForSwooleHttpd](Ext-PluginForSwooleHttpd.md)
...
+ [DuckPhp\Core\RuntimeState](Core-RuntimeState.md)
