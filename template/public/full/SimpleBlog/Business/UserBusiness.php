...
class UserBusiness extends BaseBusiness
{
    ...
    public function deleteCommentByUser($user_id, $comment_id)
    {
        ...
        static::ThrowOn(!$comment, "没找到评论");
        static::ThrowOn($comment['user_id'] != $user_id, "不是你的评论", -1);
