...
class RouteHookResource extends ComponentBase
{
    ...
    public function cloneResource($force = false, &$info = '')
    {
        ...
        $source = $this->context()->getOverrideableFile($this->options['path_resource'], '');
        ...
        $document_root = App::Root()->getOverrideableFile(App::Root()->options['path_document'] ?? 'public', '', false);
